...
(function ($) {
    ...
    abp.event.on('abp.dynamicScriptsInitialized', function () {
        abp.libs.sweetAlert.config.confirm.title = abp.localization.localize('AreYouSure','FengWo');
        abp.libs.sweetAlert.config.confirm.buttons = [abp.localization.localize('Cancel','FengWo'), abp.localization.localize('Yes','FengWo')];
    });
