    ...
    var constants = {
      3: {
        ...
        html: {
          ...
          toobarDropdowItem: '<li role="menuitem"><a>%s</a></li>',
          ...
          if (o.showColumns) {
            ...
            this.columns.forEach(function (column, i) {
              ...
              if (column.switchable) {
                html.push(Utils.sprintf(_this4.constants.html.toobarDropdowItem, Utils.sprintf('<input type="checkbox" id="%s" class="filled-in" data-field="%s" value="%s"%s> <label for="%s" style="padding-left:26px;">%s</label>', column.field,column.field, i, checked, column.field,column.title)));
                switchableCount++;
              }
            });
